...
=for vc $Id: makepp_command.pod,v 1.54 2011/11/20 18:19:06 pfeiffer Exp $
...
fall back occured in.  To get rid of only them use C<makeppclean --logs
...
log file is called F<.makepp/log>.
...
application works or L<http://www.lemoda.net/cfunctions/> for the similar
cfunctions).
...
called F<.makepp/log>.  This can be extremely valuable for debugging a
